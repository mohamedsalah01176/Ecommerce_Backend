...
router.post('/product',verifyToken,(req,res)=>productControl.addProduct(req,res))
router.patch('/product/:id',verifyToken,(req,res)=>productControl.updateProduct(req,res))
router.delete('/product/:id',verifyToken,(req,res)=>productControl.deleteProduct(req,res))
